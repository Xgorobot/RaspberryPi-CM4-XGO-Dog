...
class MychanicalDog(Thing):
    def __init__(self):
        ...
        self.add_property("attitude_r", "机械狗的滚轮角，如未明确给出转动参数，请执行预设动作",
                          lambda: self.attitude_r)
        self.add_property("attitude_p", "机械狗的俯仰角，如未明确给出转动参数，请执行预设动作，",
                          lambda: self.attitude_p)
        self.add_property("attitude_y", "机械狗的偏航角，如未明确给出转动参数，请执行预设动作",
        ...
        self.add_method(
            ...
            "让机械狗向前移动",
            [
                Parameter("speed", "移动速度(0-25之间的数字)", ValueType.NUMBER, True),
        ...
        self.add_method(
            ...
            "让机械狗向左平移",
            [
                Parameter("speed", "移动速度(0-18之间的数字)", ValueType.NUMBER, True),
                Parameter("move_time", "移动时间单位秒", ValueType.NUMBER, True)
            ],
        ...
        self.add_method(
            ...
            "让机械狗右转",
            [
                Parameter('turn_speed', "转动速度(0-150之间的数字)单位度/秒", ValueType.NUMBER, True),
